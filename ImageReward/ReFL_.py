...
def parse_args():
    ...
    parser.add_argument(
        "--aesthetics_dataset_path",
        type=str,
        default="",
        help=(
            "for ReFL pretrained loss fine-tune"
        ),
    )
...
class Trainer(object):
    ...
    def __init__(self, pretrained_model_name_or_path, train_data_dir, args):
        ...
        self.aesthetics_data_dir = args.aesthetics_dataset_path
        ...
        self.reward_model = RM.load_module('/raid/maxusen/ImageReward/train/checkpoint/blip_uni_cross_mul_bs128_fix=0.7_lr=1e-05cosine/best_lr=1e-05_1-10.pt', device=self.accelerator.device)
