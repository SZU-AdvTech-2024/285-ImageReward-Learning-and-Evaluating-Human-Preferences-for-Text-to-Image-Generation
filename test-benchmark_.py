...
def test_benchmark(args):
    ...
    if args.model == "default":
        model_names = ["openjourney", "sd2-1", "dalle2", "sd1-4", "versatile-diffusion", "cogview2"]
    elif args.model == "all":
    ...
    for benchmark_type in benchmark_types:
        ...
        model = RM.load_module(name='/raid/maxusen/ImageReward/train/checkpoint/blip_uni_cross_mul_bs128_fix=0.7_lr=1e-05cosine/best_lr=1e-05_1-10.pt', device=device, download_root=args.rm_path)
        ...
        if not os.path.isdir('/raid/maxusen/ImageReward/benchmark/'):
            os.makedirs('/raid/maxusen/ImageReward/benchmark/', exist_ok=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--prompts_path",
        default="/raid/maxusen/ImageReward/benchmark/benchmark-prompts.json",
        type=str,
