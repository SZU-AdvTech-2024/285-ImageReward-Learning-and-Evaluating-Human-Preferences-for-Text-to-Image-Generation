...
if __name__ == "__main__":
    ...
    state_dict = torch.load('/raid/maxusen/.cache/ImageReward/ImageReward.pt', map_location='cpu')
    ...
    # test model
    print("test: ")
    # model.load_state_dict(torch.load('/raid/maxusen/ImageReward/train/checkpoint/blip_uni_cross_mul_bs32_fix=0.7_lr=1e-05cosine/best_lr=1e-05.pt'))
    # model = load_model(model, '/raid/maxusen/ImageReward/train/checkpoint/blip_uni_cross_mul_bs32_fix=0.7_lr=1e-05cosine/best_lr=1e-05.pt')
    # model.eval()
