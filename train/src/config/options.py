...
parser.add_argument('--preload_path', type=str, default='/raid/maxusen/ImageReward/train/checkpoint/blip_uni_cross_mul_bs128_fix=0.7_lr=1e-05cosine/best_lr=1e-05.pt')
